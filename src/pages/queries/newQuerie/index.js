      ...
      <Header />
        <View style={s.container}>
          ...
          <TouchableOpacity
            ...
            <Text style={s.buttonText}>Otorrinolaringologista</Text>
          </TouchableOpacity>
          <TouchableOpacity
            style={s.button}
            onPress={() => setCurrentScreen('consulta')}>
            <Text style={s.buttonText}>Dentista</Text>
          </TouchableOpacity>
          <TouchableOpacity
            style={s.button}
            onPress={() => setCurrentScreen('consulta')}>
            <Text style={s.buttonText}>Neurologista</Text>
          </TouchableOpacity>
          <TouchableOpacity
            style={s.button}
            onPress={() => setCurrentScreen('consulta')}>
            <Text style={s.buttonText}>Cardiologista</Text>
          </TouchableOpacity>
        </View>
      </>
    );
